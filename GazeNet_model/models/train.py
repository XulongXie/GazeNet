...
from GazeNet_model.models.gazeData import get_train_set, get_val_set
...
def main():
    ...
    dataTrain = get_train_set(data_dir = '../label/combined_dataset')
    dataVal = get_val_set(data_dir = '../label/combined_dataset')
    ...
    for epoch in range(epoch, epochs):
        ...
        loss_avg = validate(val_loader, net, epoch)

        # remember best loss and save checkpoint
        is_best = loss_avg < best_loss
...
def train(train_loader, model, optimizer, epoch):
    ...
    for i, batch in enumerate(train_loader):
        ...
        # compute loss and accuract prediction
...
def validate(val_loader, model, epoch):
    ...
    for i, batch in enumerate(val_loader):
        ...
        n.track_num_correct(preds, gaze)
