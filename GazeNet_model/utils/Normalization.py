import torch
from GazeNet_model.models.dataloader import get_train_loader as trainloader
from GazeNet_model.models.dataloader import get_val_loader as valloader

# calculate the mean and standard deviation
def norm():
    # at this time, batch is no longer all data
    # load dataloader
    train_set, train_loader = trainloader('../../Darknet_model/label/first_dataset', batch_size=100,
                                             num_workers = 1,
                                             is_shuffle = True)

    val_set, val_loader = valloader('../../Darknet_model/label/first_dataset', batch_size=100,
                                         num_workers=1,
                                         is_shuffle=True)
